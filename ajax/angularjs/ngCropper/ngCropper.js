 ...
 * Copyright (c) 2020 FourLanding, contato@fourlanding.com, fourlanding.com
...
(function () {
  var BinaryFile = function (strData, iDataOffset, iDataLength) {
    ...
    if (typeof strData == "string") {
      ...
      this.getBytesAt = function (iOffset, iLength) {
        ...
        for (var i = 0; i < iLength; i++) {if (window.CP.shouldStopExecution(0)) break;
    ...
    this.getStringAt = function (iOffset, iLength) {
      ...
      for (var j = 0; j < iLength; j++) {if (window.CP.shouldStopExecution(1)) break;
  ...
  var EXIF = function () {
    ...
    function findEXIFinJPEG(file) {
      ...
      while (offset < length) {if (window.CP.shouldStopExecution(2)) break;
    ...
    function readTags(file, tiffStart, dirStart, strings, bigEnd) {
      ...
      for (i = 0; i < entries; i++) {if (window.CP.shouldStopExecution(3)) break;
      ...
      switch (type) {
        ...
        case 7: // undefined, 8-bit byte, value depending on field
          if (numValues == 1) {
            ...
            vals = [];
            for (n = 0; n < numValues; n++) {if (window.CP.shouldStopExecution(4)) break;
        ...
        case 3: // short, 16 bit int
          if (numValues == 1) {
            ...
            vals = [];
            for (n = 0; n < numValues; n++) {if (window.CP.shouldStopExecution(5)) break;
        ...
        case 4: // long, 32 bit int
          if (numValues == 1) {
            ...
            vals = [];
            for (var n = 0; n < numValues; n++) {if (window.CP.shouldStopExecution(6)) break;
        ...
        case 5: // rational = two long values, first is numerator, second is denominator
          if (numValues == 1) {
            ...
            vals = [];
            for (n = 0; n < numValues; n++) {if (window.CP.shouldStopExecution(7)) break;
        ...
        case 9: // slong, 32 bit signed int
          if (numValues == 1) {
            ...
            vals = [];
            for (n = 0; n < numValues; n++) {if (window.CP.shouldStopExecution(8)) break;
        ...
        case 10: // signed rational, two slongs, first is numerator, second is denominator
          if (numValues == 1) {
            ...
            vals = [];
            for (n = 0; n < numValues; n++) {if (window.CP.shouldStopExecution(9)) break;
